...
class Ui_dialog_add_steam_account(object):
    def setupUi(self, dialog_add_steam_account):
        ...
        self.buttonBox = QDialogButtonBox(dialog_add_steam_account)
        ...
        self.gridLayout_2.addWidget(self.le_account_name, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.le_password, 2, 1, 1, 1)
        ...
        self.buttonBox.accepted.connect(dialog_add_steam_account.accept)
        self.buttonBox.rejected.connect(dialog_add_steam_account.reject)
